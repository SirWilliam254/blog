...
It is of interest to see the relation with the responce variable "Survived"
...
sns.despine()
```
![Embarked impact on survival rate]({{site.baseurl}}/assets/img/Embarked.PNG){: .align-center}
...
sns.despine()
```
![NEbarked impact on survival rate]({{site.baseurl}}/assets/img/NEbarked.PNG){: .align-center}
